        ...
        <div class="col-sm-8">
            <div class="page-header">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th class="text-right">Nombre Usuario:</th>
                        <td class="edit-cell" data-input-edit-cell="true" data-val="<?= $modelo->nombre_usuario ?>">
                            <?= CBoot::text($modelo->nombre_usuario, ['id' => 'nombre_usuario']) ?>
                        </td>
                    </tr>  
                </table>
            </div>
        ...
        $.ajax({
            ...
            success: function (respuesta) {
                if (respuesta.error === true) {
                    mostrarAlert("error", "Ya existe una cuenta asociada a ese nombre de usuario");
                    $("#nombre_usuario").focus().select();
                } else {                    
